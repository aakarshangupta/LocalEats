...
const User = () => {
    ...
    let data3 = [
        {userId: 123, imgSrc:userImg, userName: "Aakarshan", reviews: 500, followers: "272"},
        {userId: 123, imgSrc:userImg, userName: "Aakarshan", reviews: 500, followers: "272"},
        {userId: 123, imgSrc:userImg, userName: "Aakarshan", reviews: 500, followers: "272"},
        {userId: 123, imgSrc:userImg, userName: "Aakarshan", reviews: 500, followers: "272"}
    ]
    ...
    <div className={css.box}>
      ...
      <div className={css.mainbody}>
        <div className={css.leftBox}>
          ...
          <ProfileWidget name='LocalEats PROFILE WIDGET' tag="Showcase your LocalEats profile on your blog." data={data4} />
        </div>
